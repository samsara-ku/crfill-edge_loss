...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--trainer', type=str, default='pix2pix')
        # for displays
        ...
        parser.add_argument('--no_gan_loss', action='store_true', help='if specified, do *not* use VGG feature matching loss')
        parser.add_argument('--masked_loss', action='store_true', help='if specified, apply mask on VGG feature matching loss')
